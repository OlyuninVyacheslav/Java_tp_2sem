...
public class SqlRepository<Entity> {
        ...
        if (Objects.isNull(table)) {
            ...
            for (Field field : clazz.getDeclaredFields()) {
                ...
                if (annotation != null) {
                    ...
                    switch (typeName) {
                        case "String" -> sqlQuery.append(fieldName).append("\s").append("TEXT").append("\s").append(nullParameter);
                        case "int" -> sqlQuery.append(fieldName).append("\s").append("INTEGER").append("\s").append(nullParameter);
    ...
    public void insert(Entity human) throws IllegalAccessException, SQLException {
        ...
        if (Objects.isNull(table)) {
            ...
            for (Field field : clazz.getDeclaredFields()) {
                ...
                if (column != null) {
                    Object fieldValue = field.get(human);
